	...
	<table class="form-table">
		<tbody>
			<tr class="form-field">
				...
				<td>
					<input name="name" id="edd-name" type="text" value="<?php echo $discount['name']; ?>" style="width: 300px;"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="edd-code" name="code" value="<?php echo $discount['code']; ?>" style="width: 300px;"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="edd-amount" name="amount" value="<?php echo $discount['amount']; ?>" style="width: 40px;"/>
			...
			<tr class="form-field">
				...
				<td>
					<input name="expiration" id="edd-expiration" type="text" value="<?php echo $discount['expiration']; ?>" style="width: 120px;" class="edd_datepicker"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="edd-max-uses" name="max" value="<?php echo $discount['max']; ?>" style="width: 40px;"/>
